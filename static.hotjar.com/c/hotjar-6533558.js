window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "cs_tag_name": null,
    "account_id": 5014533,
    "account_signature": "dd37bcc85435593d2b4713618c10ca2643ff00712e27bf50c5238c6559c6d5be"
};
...
!function () {
    ...
    var o, s = function () {
        ...
        var r;
        c.loggedMetrics[e] = a(a({}, c.loggedMetrics[e]), {}, ((r = {})[t] = n || {},
            r))
    }, d = function (e) {
        if (!e)
            return "value";
        ...
        return "lab" === e && (n = u.browser.inLab),
            "field" === e && (n = c.isFieldMetricsEnabled),
            t ? n && t.flush : n
    }, f = function (e) {
        var t = !1
            , n = "v=".concat(u.version)
            , r = "".concat(u.metricsUrl, "?").concat(n, "&site_id=").concat(window.hjSiteSettings.site_id) + (c.isDebugEnabled ? "&debug=true" : "")
            , i = JSON.stringify(e);
        ...
        start: function () {
            try {
                ...
                return c.genericTags = {
                    ...
                    c.isDebugEnabled = Math.random() <= l.universalDebug || a.has("client_script.metrics.debug") && Math.random() <= l.debug,
                    c.isMetricsEnabled = Math.random() <= l.metrics,
                    c.isFieldMetricsEnabled = c.isMetricsEnabled && Math.random() <= l.fieldMetrics,
                    o = new i(f, u.buffer.bufferSize, u.buffer.flushInterval),
                    e
            } catch (e) {
        ...
        count: function (e, t) {
            var n = t.incr
                ...
                , s = t.type;
            try {
                var u, l = d(r), f = c.loggedMetrics[e], p = 0;
                if (n ? (p = (f && f[l] || 0) + (n.value || 1),
                    c.loggedMetrics[e] = a(a({}, f), {}, ((u = {})[l] = null != n && n.flush ? 0 : p,
                        u))) : p = 1,
                    h(s, n)) {
                    var v = {
                        name: e,
        ...
        timeIncr: function (e, t) {
            var n, r, i, a, o = t.tag, s = t.start, u = t.flush, g = t.extraTags, h = t.type, f = hj.metrics.time(), v = s && f ? f - s : void 0, m = (n = e,
            {
                tagName: r = d(o),
        ...
        timeWatcher: function () {
            var e, t = 0, n = !1, r = function () {
                var n, r = p.time();
                return t += null !== (n = e && r && r - e) && void 0 !== n ? n : 0,
                    e = p.time(),
                    t
            };
            return {
    ...
    var b = "https://voc.hotjar.com"
        , y = [b, "https://voc.ew1-integration-1.hotjarians.net", "https://hj-engage-unmoderated-review.s3.eu-west-1.amazonaws.com"]
        , j = "hj-uut"
        , _ = {
            get: function () {
            ...
            set: function (e) {
                if (e) {
                    var t, n = null !== (t = _.get()) && void 0 !== t ? t : {};
    ...
    var O, x = function () {
        var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = null === (e = _hjSettings) || void 0 === e ? void 0 : e.environment, r = t.isCSQLite ? "t.contentsquare.net" : "t.cs.hotjar.io";
        n && "live" !== n && (r = t.isCSQLite ? "t-staging.contentsquare.net" : "t-staging.cs.hotjar.io");
    ...
    function C() {
        ...
        window.hj = window.hj || function () {
            ...
            window.hj.metrics = p,
            hj.metrics.start();
        var r, i, a, o, s, u, c, l, d, g, h, f, w = !(!window.CS_CONF || null === (e = window.CS_CONF.voc) || void 0 === e || !e.enabled), b = !(window.CS_CONF || null === (t = window.hjSiteSettings) || void 0 === t || null === (n = t.features) || void 0 === n || !n.includes("cs_lite"));
        if (w && window._uxa)
            window._uxa.push(["start:hotjar", hjSiteSettings]),
                window.hj.scriptLoaded = !0;
        else if (b) {
            var y = (u = (r = hjSiteSettings).suppress_all || r.suppress_text || (null === (i = r.suppress_all_on_specific_pages) || void 0 === i ? void 0 : i.length),
                c = function (e) {
                    var t, n, r, i, a, o = {
                    ...
                    if ((e.suppress_all || e.suppress_text) && (o.anonymisationMethod = v.replayRecordingMaskedUrlRegex,
                        ...
                        var s = (n = e.suppress_all_on_specific_pages,
                            r = {
                                contains: m.CONTAIN,
                                regex: m.CONTAIN,
                                simple: m.CONTAIN,
                ...
                h = !(null === (a = _hjSettings) || void 0 === a || !a.environment || "live" === _hjSettings.environment),
            {
                CS_CONF_BASE: {
                    ...
                    smbConfig: {
                        ...
                        useCSTC: !0,
                        useSentry: !0,
                        csLiteDomain: h ? "insights-integration.live.eks.hotjar.com" : "insights.hotjar.com"
                    },
                    hostnames: [window.location.hostname],
                    voc: null !== (o = r.polls) && void 0 !== o && o.length || R() ? {
                        enabled: 1,
                        siteId: r.site_id
                    } : {
                        enabled: 0
                    ...
                    implementations: (s = r,
                        T(E, (f = s.state_change_listen_mode,
                            "manual" === f ? [] : [{
                                template: {
                    ...
                    recordTargetingRules: T(E, r.record_targeting_rules),
                    anonymisationMethod: l,
                    replayRecordingMaskedUrlRegex: d,
                    replayRecordingMaskedUrlRegexRules: g
                },
                PII_SELECTORS: r.suppress_all ? ["picture, img, video, audio"] : null
            })
                , j = y.CS_CONF_BASE
                , _ = y.PII_SELECTORS;
            window.CS_CONF_BASE = j,
                window._uxa = window._uxa || [],
                _ && window._uxa.push(["setPIISelectors", {
                    PIISelectors: _
                }]),
                x({
                    isCSQLite: b
            ...
            window.hjBootstrap = window.hjBootstrap || function (e, t, n) {
                var r, i, a = new RegExp("bot|google|headless|baidu|bing|msn|duckduckbot|teoma|slurp|yandex|phantomjs|pingdom|ahrefsbot|facebook", "i"), o = (null === (r = window.navigator) || void 0 === r ? void 0 : r.userAgent) || "unknown";
                if (a.test(o))
                ...
                var s = "http:" === window.location.protocol
                    , u = Boolean(null === (i = _hjSettings) || void 0 === i ? void 0 : i.preview);
                if (s && !u)
                    return hj.metrics.count("session-rejection", {
                        tag: {
                            reason: "https"
                ...
                window.hjBootstrap = function (e, t, n) {
                    var r;
                    window.hjBootstrapCalled = (window.hjBootstrapCalled || []).concat(n),
                        window.hj && window.hj._init && !hj.features.isUchRouted() && (null === (r = hj._init) || void 0 === r || r._verifyInstallation())
                }
                    ,
                    window.hjBootstrap(e, t, n),
                    window.hjBootstrap.revision = "a862bed";
                ...
                ,
                window.hjBootstrap("https://script.hotjar.com/", "modules.b3c3d2ffe9c422f77646.js", "6533558")
    }
    window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.d460463fda0945455e20.js"
        },
        SURVEY_BOOTSTRAPPER: {
        ...
        SURVEY_INVITATION: {
            js: "survey-invitation.014136c28ea41cdc2e32.js"
        },
        NOTIFICATION: {
        ...
        USER_TEST: {
            js: "user-test.aded00fb6aa2ffbb5cb7.js"
        }
    };
    var I = null !== (O = hjSiteSettings.features) && void 0 !== O ? O : [];
    I.indexOf("one_app_tag") > -1 ? x() : I.indexOf("one_app_tag_dc") > -1 ? (x(),
