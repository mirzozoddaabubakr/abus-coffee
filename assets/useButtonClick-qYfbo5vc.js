...
import { c as r, s as i } from "./chunk-QFMPRPBF-DCa5F_AN.js";
var a = e(n(), 1)
    , o = `1.3.23`;
function s(e, t, n) {
...
var d = class {
    ...
    advance(e) {
        ...
        if (this.duration && this.easing) {
            this.currentTime += e;
            let n = s(0, this.currentTime / this.duration, 1);
            t = n >= 1;
            let r = t ? 1 : this.easing(n);
            this.value = this.from + (this.to - this.from) * r
        } else
            this.lerp ? (this.value = l(this.value, this.to, this.lerp * 60, e),
...
var p = class {
    ...
    constructor(e, t, { autoResize: n = !0, debounce: r = 250 } = {}) {
        this.wrapper = e,
            this.content = t,
            n && (this.debouncedResize = f(this.resize, r),
...
var v = class {
    ...
    constructor(e, t = {
        ...
        this.element = e,
            ...
            this.onWindowResize(),
            this.element.addEventListener(`wheel`, this.onWheel, g),
            this.element.addEventListener(`touchstart`, this.onTouchStart, g),
            this.element.addEventListener(`touchmove`, this.onTouchMove, g),
            this.element.addEventListener(`touchend`, this.onTouchEnd, g)
    }
    on(e, t) {
    ...
    destroy() {
        this.emitter.destroy(),
            ...
            this.element.removeEventListener(`wheel`, this.onWheel, g),
            this.element.removeEventListener(`touchstart`, this.onTouchStart, g),
            this.element.removeEventListener(`touchmove`, this.onTouchMove, g),
            this.element.removeEventListener(`touchend`, this.onTouchEnd, g)
    }
    onTouchStart = e => {
    ...
    onWheel = e => {
        let { deltaX: t, deltaY: n, deltaMode: r } = e
            , i = _(r, this.window.width)
            , a = _(r, this.window.height);
        t *= i,
            n *= a,
    ...
    , b = class {
        ...
        dimensions;
        virtualScroll;
        constructor({ wrapper: e = window, content: t = document.documentElement, eventsTarget: n = e, smoothWheel: r = !0, syncTouch: i = !1, syncTouchLerp: a = .075, touchInertiaExponent: s = 1.7, duration: c, easing: l, lerp: u = .1, infinite: d = !1, orientation: f = `vertical`, gestureOrientation: m = f === `horizontal` ? `both` : `vertical`, touchMultiplier: h = 1, wheelMultiplier: g = 1, autoResize: _ = !0, prevent: b, virtualScroll: x, overscroll: S = !0, autoRaf: C = !1, anchors: w = !1, autoToggle: T = !1, allowNestedScroll: E = !1, __experimental__naiveDimensions: D = !1, naiveDimensions: O = D, stopInertiaOnNavigate: k = !1 } = {}) {
            window.lenisVersion = o,
                window.lenis || (window.lenis = {}),
                window.lenis.version = o,
                f === `horizontal` && (window.lenis.horizontal = !0),
                i === !0 && (window.lenis.touch = !0),
                (!e || e === document.documentElement) && (e = window),
                typeof c == `number` && typeof l != `function` ? l = y : typeof l == `function` && typeof c != `number` && (c = 1),
                this.options = {
                    wrapper: e,
                    content: t,
                    eventsTarget: n,
        ...
        raf = e => {
            ...
            ;
        scrollTo(e, { offset: t = 0, immediate: n = !1, lock: r = !1, programmatic: i = !0, lerp: a = i ? this.options.lerp : void 0, duration: o = i ? this.options.duration : void 0, easing: c = i ? this.options.easing : void 0, onStart: l, onComplete: u, force: d = !1, userData: f } = {}) {
            ...
            if (typeof p == `string` && [`top`, `left`, `start`, `#`].includes(p))
                p = 0;
            else if (typeof p == `string` && [`bottom`, `right`, `end`].includes(p))
                p = this.limit;
            else {
                let e = null;
                if (typeof p == `string` ? (e = document.querySelector(p),
                    e || (p === `#top` ? p = 0 : console.warn(`Lenis: Target not found`, p))) : p instanceof HTMLElement && p?.nodeType && (e = p),
                    e) {
                    ...
                    p = (this.isHorizontal ? t.left : t.top) + this.animatedScroll - (Number.isNaN(r) ? 0 : r) - (Number.isNaN(a) ? 0 : a)
                }
            }
            if (typeof p == `number`) {
                if (p += m,
                    ...
                    if (i) {
                        ...
                        e > this.limit / 2 ? p -= this.limit : e < -this.limit / 2 && (p += this.limit)
                    }
                } else
                    p = s(0, p, this.limit);
                ...
                i || (this.targetScroll = p),
                    typeof o == `number` && typeof c != `function` ? c = y : typeof c == `function` && typeof o != `number` && (o = 1),
        ...
        get scroll() {
            return this.options.infinite ? u(this.animatedScroll, this.limit) : this.animatedScroll
        }
        get progress() {
...
function C(e) {
    let [t, n] = (0,
        a.useState)(e.get());
    return (0,
        a.useEffect)(() => e.subscribe(e => n(e)), [e]),
        t
}
var w = (0,
    ...
    , T = new S(null)
    , E = (0,
        a.forwardRef)(({ children: e, root: t = !1, options: n = {}, autoRaf: r = !0, className: i = ``, ...o }, s) => {
            let c = (0,
                a.useRef)(null)
                , l = (0,
                    a.useRef)(null)
                ...
                (0,
                    a.useEffect)(() => {
                        if (!u)
                            return;
                        let e = e => {
                            for (let { callback: t } of f.current)
                                t(e)
                        }
                            ;
...
function O(e, t = [], n = 0) {
    let r = (0,
        a.useContext)(w)
        , i = C(T)
        , { lenis: o, addCallback: s, removeCallback: c } = r ?? i ?? D;
    return (0,
        a.useEffect)(() => {
            if (e && s && c && o)
                return s(e, n),
    ...
    return r => {
        if (e) {
            ...
            if (i)
                ...
                r?.preventDefault();
                let [t, i] = e.split(`#`);
                t === a.pathname ? i && s(i, 50) : (n(t),
                    i && setTimeout(() => {
                        s(i, 100)
                    }
                        , 100))
            } else
                e.startsWith(`#`) ? (r?.preventDefault(),
                    s(e.slice(1), 50)) : (r?.preventDefault(),
                        s(e, 50))
        }
        t?.()
    }
