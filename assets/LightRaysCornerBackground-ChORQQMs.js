                        ...
                        children: [(0,
                            n.jsx)(`div`, {
                                ...
                                style: {
                                    ...
                                    animation: `rotated-ray-pulse 4s ease-in-out 0s infinite both`
                                }
                            }), (0,
                                n.jsx)(`div`, {
                                    className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top-right overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                    style: {
                                        ...
                                        animation: `rotated-ray-pulse 3.5s ease-in-out 0.5s infinite both`
                                    }
                                }), (0,
                                    n.jsx)(`div`, {
                                        ...
                                        style: {
                                            ...
                                            animation: `rotated-ray-pulse 5s ease-in-out 1.2s infinite both`
                                        }
                                    }), (0,
                                        n.jsx)(`div`, {
                                            ...
                                            style: {
                                                ...
                                                animation: `rotated-ray-pulse 3s ease-in-out 0.3s infinite both`
                                            }
                                        }), (0,
                                            n.jsx)(`div`, {
                                                ...
                                                style: {
                                                    ...
                                                    animation: `rotated-ray-pulse 4.5s ease-in-out 0.8s infinite both`
                                                }
                                            }), (0,
                                                n.jsx)(`div`, {
                                                    className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-10px)] w-[20px] origin-top-right overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                    style: {
                                                        ...
                                                        animation: `rotated-ray-pulse 3.2s ease-in-out 1.5s infinite both`
                                                    }
                                                }), (0,
                                                    n.jsx)(`div`, {
                                                        className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top-right overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                        style: {
                                                            ...
                                                            animation: `rotated-ray-pulse 4.2s ease-in-out 0.2s infinite both`
                                                        }
                                                    }), (0,
                                                        n.jsx)(`div`, {
                                                            className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top-right overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                            style: {
                                                                ...
                                                                animation: `rotated-ray-pulse 3.8s ease-in-out 1s infinite both`
                                                            }
                                                        }), (0,
                                                            n.jsx)(`div`, {
