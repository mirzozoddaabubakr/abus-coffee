/* clarity-js v0.8.67: https://github.com/microsoft/clarity (License: MIT) */
!function () {
    "use strict";
    ...
    function ci(t, e, n) {
        void 0 === t.__clr[e] && (t.__clr[e] = t.CSSStyleSheet.prototype[e],
            t.CSSStyleSheet.prototype[e] = function () {
                return bo() && bt.includes(this[gt]) && fi(Cn(), this[gt], n, arguments[0]),
    ...
    function si(t, e) {
        ...
        if ((!xn.lean || !xn.lite) && (yt.includes(t) || (yt.push(t),
            ...
            for (n = [],
                ...
                (r = i[a])[gt] && bt.includes(r[gt]) || (r[gt] = ao(),
                    bt.push(r[gt]),
                    fi(e, r[gt], 0),
                    fi(e, r[gt], 2, Wi(r))),
                    n.push(r[gt]);
    ...
    function vi(t, e) {
        var n, a, i, r, o;
        if (bo() && (a = (null == (n = t.effect) ? void 0 : n.target) ? Fi(n.target) : null,
            n && null !== a && !n.pseudoElement && n.getKeyframes && n.getTiming && (t[Et] || (t[Et] = ao(),
                t[Tt] = 0,
                i = n.getKeyframes(),
                r = n.getTiming(),
            ...
            function (t) {
                !function (t) {
                    ...
                    t.nodeType === Node.DOCUMENT_NODE && (function (t) {
                        lo(t, "click", Ea.bind(this, 9, t), !0),
                            lo(t, "contextmenu", Ea.bind(this, 48, t), !0)
                    }(t),
                        function (t) {
                            lo(t, "cut", xa.bind(this, 0), !0),
                                lo(t, "copy", xa.bind(this, 1), !0),
                                lo(t, "paste", xa.bind(this, 2), !0)
                        }(t),
                        function (t) {
                            lo(t, "mousedown", Ra.bind(this, 13, t), !0),
                                lo(t, "mouseup", Ra.bind(this, 14, t), !0),
                                lo(t, "mousemove", Ra.bind(this, 12, t), !0),
                                lo(t, "wheel", Ra.bind(this, 15, t), !0),
                                lo(t, "dblclick", Ra.bind(this, 16, t), !0),
                                lo(t, "touchstart", La.bind(this, 17, t), !0),
                                lo(t, "touchend", La.bind(this, 18, t), !0),
                                lo(t, "touchmove", La.bind(this, 19, t), !0),
                                lo(t, "touchcancel", La.bind(this, 20, t), !0)
                        }(t),
                        function (t) {
                            lo(t, "input", Da, !0),
                                lo(t, "keydown", Ca, !0)
                        ...
                        function (t) {
                            lo(t, "selectstart", Ja.bind(this, t), !0),
                                lo(t, "selectionchange", Ja.bind(this, t), !0)
                        }(t),
                        function (t) {
                            lo(t, "change", wa, !0)
                        }(t),
        ...
        if (void 0 === t && (t = $e),
            ...
            if (Ze = a,
                ...
                return xn.track = !1,
                    Qr(!0),
                    _o(),
                    void window.setTimeout(Mo, 250);
            bo() && i.analytics_Storage && (xn.track = !0,
                no(ro(), 1),
                qr(15, $r()),
                eo()),
                Br(),
    ...
    function ro() {
        ...
        return n && n.length > 0 && ((t = n.includes("^") ? n.split("^") : n.split("|")).length > 1 && (e.version = io(t[1])),
            t.length > 2 && (e.expiry = io(t[2], 36)),
            t.length > 3 && 1 === io(t[3]) && (e.consent = 1),
            t.length > 4 && io(t[1]) > 1 && (e.dob = io(t[4])),
    ...
    function Eo() {
        ...
        try {
            for (Sn && Sn.disconnect(),
                Sn = new PerformanceObserver(co(To)),
                t = 0,
                e = En; t < e.length; t++)
                n = e[t],
    ...
    function Mo(e) {
        void 0 === e && (e = null),
            function (t) {
                ...
                on = yo(),
                un = 0,
                lo(window, "popstate", vo),
                an = go(an, "pushState"),
                rn = go(rn, "replaceState"),
                f = {},
                h = {},
                Bn(5),
        ...
        bo() && (Nn.slice().reverse().forEach((function (t) {
            ...
            void 0 !== _n && (_n[On] = function () {
                (_n[On].q = _n[On].q || []).push(arguments),
                    "start" === arguments[0] && _n[On].q.unshift(_n[On].q.pop()) && Oo()
            }
            ))
    }
    function Oo() {
        ...
        I = [{
            ...
            start: function () {
                ...
                Ge = f.indexOf("Electron") > 0 ? 1 : 0,
                    ...
                    (s = va("_clsk", !xn.includeSubdomains)) && (c = s.includes("^") ? s.split("^") : s.split("|")).length >= 5 && l.ts - io(c[1]) < 18e5 && (l.session = c[0],
                        l.count = io(c[2]) + 1,
                        l.upgrade = io(c[3]),
                    ...
                    navigator && (qr(9, navigator.language),
                        ...
                        (u = navigator.userAgentData) && u.getHighEntropyValues ? u.getHighEntropyValues(["model", "platformVersion"]).then((function (t) {
                            var e;
                            qr(22, t.platform),
        ...
        Nn = [{
            ...
            start: function () {
                Si(),
                    ...
                    Ui(),
                    zi(document, !0),
                    xn.delayDom ? lo(window, "load", (function () {
                        Ni()
                    }
                    )) : Ni(),
                    function () {
            ...
            start: function () {
                fe = [],
                    ...
                    lo(window, "resize", $),
                    Ha(),
                    lo(document, "visibilitychange", ei),
                    ei(),
                    lo(window, "focus", (function () {
                        return ii(1)
                    }
                    )),
                ...
                ko(),
                    function () {
                        navigator && navigator.connection && qr(27, navigator.connection.effectiveType),
                            window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? lo(window, "load", Gn.bind(this, Eo, 0)) : Eo() : _r(3, 0)
                    }()
            },
            stop: function () {
                Sn && Sn.disconnect(),
