...
var n = e()
    , r = ({ position: e }) => (0,
        n.jsx)(`div`, {
            className: t(e, `inset-0 -z-10 overflow-hidden pointer-events-none select-none`, e === `absolute` && `mask-[linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]`),
            "aria-hidden": `true`,
            children: (0,
                n.jsx)(`div`, {
