...
var n = e()
    , r = ({ position: e }) => (0,
        n.jsxs)(`div`, {
            className: t(e, `inset-0 -z-10 w-full h-full overflow-hidden bg-background pointer-events-none`, e === `absolute` && `mask-[linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]`),
            children: [(0,
                n.jsx)(`div`, {
