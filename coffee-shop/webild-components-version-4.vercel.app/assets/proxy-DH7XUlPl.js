import { a as e, i as t, o as n, r, t as i } from "./jsx-runtime-9YgKe2Eq.js";
import { t as a } from "./react-CM_0bdEm.js";
var o = i()
    , s = n(a(), 1)
    , c = (0,
        s.createContext)({});
...
var x = e => e
    ...
    , T = class {
        ...
        add(e) {
            return f(this.subscriptions, e),
                () => p(this.subscriptions, e)
        }
        notify(e, t, n) {
...
var te = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e
    , ne = 1e-7
    , re = 12;
    ...
    let u = {
        ...
        process: e => {
            ...
            n = r,
                r = o,
                n.forEach(l),
                t && O.value && O.value.frameloop[t].push(c),
                c = 0,
                n.clear(),
                i = !1,
                a && (a = !1,
...
var { schedule: k, cancel: A, state: j, steps: De } = Ee(typeof requestAnimationFrame < `u` ? requestAnimationFrame : x, !0), Oe;
function ke() {
    Oe = void 0
}
var M = {
    now: () => (Oe === void 0 && M.set(j.isProcessing || g.useManualTiming ? j.timestamp : performance.now()),
        Oe),
    set: e => {
        Oe = e,
            queueMicrotask(ke)
...
var He = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu
    , Ue = (e, t) => n => !!(typeof n == `string` && He.test(n) && n.startsWith(e) || t && !Ve(n) && Object.prototype.hasOwnProperty.call(n, t))
    , We = (e, t, n) => r => {
        if (typeof r != `string`)
            return r;
        let [i, a, o, s] = r.match(Be);
        return {
            [e]: parseFloat(i),
            [t]: parseFloat(a),
            [n]: parseFloat(o),
    ...
    , Ke = {
        ...Ie,
        transform: e => Math.round(Ge(e))
    }
    , qe = {
        test: Ue(`rgb`, `red`),
        parse: We(`red`, `green`, `blue`),
        transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) => `rgba(` + Ke.transform(e) + `, ` + Ke.transform(t) + `, ` + Ke.transform(n) + `, ` + ze(Le.transform(r)) + `)`
    };
function Je(e) {
    let t = ``
        , n = ``
...
var Ye = {
    ...
    , et = {
        ...
        transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => `hsla(` + Math.round(e) + `, ` + F.transform(ze(t)) + `, ` + F.transform(ze(n)) + `, ` + ze(Le.transform(r)) + `)`
    }
    , L = {
        test: e => qe.test(e) || Ye.test(e) || et.test(e),
        parse: e => qe.test(e) ? qe.parse(e) : et.test(e) ? et.parse(e) : Ye.parse(e),
        transform: e => typeof e == `string` ? e : e.hasOwnProperty(`red`) ? qe.transform(e) : et.transform(e),
        getAnimatableNone: e => {
            let t = L.parse(e);
            return t.alpha = 0,
                L.transform(t)
...
function nt(e) {
    return isNaN(e) && typeof e == `string` && (e.match(Be)?.length || 0) + (e.match(tt)?.length || 0) > 0
}
var rt = `number`
    , it = `color`
    , at = `var`
...
function lt(e) {
    ...
    return {
        values: n,
        split: t.replace(ct, e => (L.test(e) ? (r.color.push(a),
            i.push(it),
            n.push(L.parse(e))) : e.startsWith(ot) ? (r.var.push(a),
                i.push(at),
    ...
    return r => {
        ...
        for (let a = 0; a < n; a++)
            if (i += e[a],
                r[a] !== void 0) {
                let e = t[a];
                e === rt ? i += ze(r[a]) : e === it ? i += L.transform(r[a]) : i += r[a]
            }
        return i
    }
}
...
var pt = e => typeof e == `number` ? 0 : L.test(e) ? L.getAnimatableNone(e) : e
    , mt = (e, t) => typeof e == `number` ? t?.trim().endsWith(`/`) ? e : 0 : pt(e);
function ht(e) {
    let t = lt(e);
...
var Ct = (e, t) => {
    ...
    return e => (i.red = yt(n.red, r.red, e),
        i.green = yt(n.green, r.green, e),
        i.blue = yt(n.blue, r.blue, e),
...
function Dt(e) {
    return typeof e == `number` ? Et : typeof e == `string` ? Ne(e) ? vt : L.test(e) ? Ct : jt : Array.isArray(e) ? Ot : typeof e == `object` ? L.test(e) ? Ct : kt : vt
}
function Ot(e, t) {
    let n = [...e]
        , r = n.length
        , i = e.map((e, n) => Dt(e)(e, t[n]));
    return e => {
        for (let t = 0; t < r; t++)
            n[t] = i[t](e);
        return n
...
function kt(e, t) {
    let n = {
        ...
        , r = {};
    for (let i in n)
        e[i] !== void 0 && t[i] !== void 0 && (r[i] = Dt(e[i])(e[i], t[i]));
    return e => {
        for (let t in r)
            n[t] = r[t](e);
        return n
...
var jt = (e, t) => {
    let n = R.createTransformer(t)
        , r = lt(e)
        , i = lt(t);
    return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? wt.has(e) && !i.values.length || wt.has(t) && !r.values.length ? Tt(e, t) : C(Ot(At(r, i), i.values), n) : (`${e}${t}`,
        vt(e, t))
}
    ;
function Mt(e, t, n) {
    return typeof e == `number` && typeof t == `number` && typeof n == `number` ? z(e, t, n) : Dt(e)(e, t)
}
var Nt = e => {
    ...
    return {
        ...
        stop: () => A(t),
        now: () => j.isProcessing ? j.timestamp : M.now()
    }
}
    , Pt = (e, t, n = 10) => {
        let r = ``
...
var Vt = .001;
function Ht({ duration: e = B.duration, bounce: t = B.bounce, velocity: n = B.velocity, mass: r = B.mass }) {
    let i, a;
    B.maxDuration;
    let o = 1 - t;
    o = m(B.minDamping, B.maxDamping, o),
        e = m(B.minDuration, B.maxDuration, D(e)),
        o < 1 ? (i = t => {
            let r = t * o
                , i = r * e
                , a = r - n
...
function qt(e = B.visualDuration, t = B.bounce) {
    let n = typeof e == `object` ? e : {
        ...
        , _ = D(Math.sqrt(c / u))
        , v = Math.abs(g) < 5;
    r ||= v ? B.restSpeed.granular : B.restSpeed.default,
        i ||= v ? B.restDelta.granular : B.restDelta.default;
    let y, b, x, S, C, w;
    if (h < 1)
        x = Rt(_, h),
            S = (m + h * _ * g) / x,
    ...
    let T = {
        ...
        ,
        toString: () => {
            let e = Math.min(It(T), Ft)
                , t = Pt(t => T.next(e * t).value, e, 30);
            return e + `ms ` + t
        }
        ,
        toTransition: () => { }
...
function Zt(e, t, n) {
    ...
    for (let n = 0; n < a; n++) {
        let a = i(e[n], e[n + 1]);
        t && (a = C(Array.isArray(t) ? t[n] || x : t, a)),
            r.push(a)
    }
    return r
}
...
function rn({ duration: e = 300, keyframes: t, times: n, ease: r = `easeInOut` }) {
    let i = ve(r) ? r.map(Se) : Se(r)
        ...
        , o = Qt(tn(n && n.length === t.length ? n : en(t), e), t, {
            ease: Array.isArray(i) ? i : nn(t, i)
        });
    return {
...
var an = e => e !== null;
function on(e, { repeat: t, repeatType: n = `loop` }, r, i = 1) {
    let a = e.filter(an)
...
function cn(e) {
    typeof e.type == `string` && (e.type = sn[e.type])
}
var ln = class {
    constructor() {
        this.updateFinished()
    ...
    , dn = class extends ln {
        constructor(e) {
            super(),
                ...
                this.stop = () => {
                    ...
                    e && e.updatedAt !== M.now() && this.tick(M.now()),
                        this.isStopped = !0,
        ...
        initAnimation() {
            let { options: e } = this;
            cn(e);
            let { type: t = rn, repeat: n = 0, repeatDelay: r = 0, repeatType: i, velocity: a = 0 } = e
                , { keyframes: o } = e
                , s = t || rn;
            s !== rn && typeof o[0] != `number` && (this.mixKeyframes = C(un, Mt(o[0], o[1])),
                o = [0, 100]);
            let c = s({
                ...e,
                keyframes: o
        ...
        tick(e, t = !1) {
            ...
            if (u) {
                ...
                !n && e >= 1 && (n = 1),
                    ...
                    t = Math.min(t, u + 1),
                    t % 2 && (d === `reverse` ? (n = 1 - n,
                        f && (n -= f / o)) : d === `mirror` && (b = a)),
                    y = m(0, 1, n) * o
            }
            let x;
            v ? (this.delayState.value = l[0],
                x = this.delayState) : x = b.next(y),
            ...
            return C && p !== Xt && (x.value = on(l, this.options, g, this.speed)),
                h && h(x.value),
                C && this.finish(),
                x
        }
        ...
        set speed(e) {
            ...
            t && this.driver && this.updateTime(M.now()),
                this.playbackSpeed = e,
                t && this.driver && (this.time = D(this.currentTime))
        }
        play() {
            if (this.isStopped)
                return;
...
var V = e => e * 180 / Math.PI
    , pn = e => hn(V(Math.atan2(e[1], e[0])))
    , mn = {
        x: 4,
        y: 5,
        translateX: 4,
    ...
    , yn = {
        ...
        scaleY: vn,
        scale: e => (_n(e) + vn(e)) / 2,
        rotateX: e => hn(V(Math.atan2(e[6], e[5]))),
        rotateY: e => hn(V(Math.atan2(-e[2], e[0]))),
        rotateZ: gn,
        rotate: gn,
...
var wn = [`transformPerspective`, `x`, `y`, `z`, `translateX`, `translateY`, `translateZ`, `scale`, `scaleX`, `scaleY`, `rotate`, `rotateX`, `rotateY`, `rotateZ`, `skew`, `skewX`, `skewY`]
    , Tn = new Set(wn)
    , En = e => e === Ie || e === I
    , Dn = new Set([`x`, `y`, `z`])
...
var H = {
    ...
    x: (e, { transform: t }) => xn(t, `x`),
    y: (e, { transform: t }) => xn(t, `y`)
};
H.translateX = H.x,
    H.translateY = H.y;
var U = new Set
...
function Nn() {
    if (jn) {
        let e = Array.from(U).filter(e => e.needsMeasurement)
    ...
    jn = !1,
        An = !1,
        U.forEach(e => e.complete(Mn)),
        U.clear()
}
function Pn() {
    U.forEach(e => {
        e.readKeyframes(),
            e.needsMeasurement && (jn = !0)
    }
    )
}
function Fn() {
...
var In = class {
    ...
    scheduleResolve() {
        this.state = `scheduled`,
            this.isAsync ? (U.add(this),
                An || (An = !0,
                    k.read(Pn),
                    k.resolveKeyframes(Nn))) : (this.readKeyframes(),
                        this.complete())
    }
    readKeyframes() {
    ...
    cancel() {
        this.state === `scheduled` && (U.delete(this),
            this.state = `pending`)
    }
    resume() {
    ...
    , Ln = e => e.startsWith(`--`);
function Rn(e, t, n) {
    Ln(t) ? e.style.setProperty(t, n) : e.style[t] = n
}
var zn = {};
function Bn(e, t) {
    let n = b(e);
...
var Vn = Bn(() => window.ScrollTimeline !== void 0, `scrollTimeline`)
    , Hn = Bn(() => window.ViewTimeline !== void 0, `viewTimeline`)
    , Un = Bn(() => {
        try {
        ...
        , `linearEasing`)
    , Wn = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`
    , Gn = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
...
function Kn(e, t) {
    if (e)
        return typeof e == `function` ? Un() ? Pt(e, t) : `ease-out` : ye(e) ? Wn(e) : Array.isArray(e) ? e.map(e => Kn(e, t) || Gn.easeOut) : Gn[e]
}
function qn(e, t, n, { delay: r = 0, duration: i = 300, repeat: a = 0, repeatType: o = `loop`, ease: s = `easeOut`, times: c } = {}, l = void 0) {
    let u = {
        [t]: n
    };
    c && (u.offset = c);
...
function Yn({ type: e, ...t }) {
    return Jn(e) && Un() ? e.applyToOptions(t) : (t.duration ??= 300,
        t.ease ??= `easeOut`,
        t)
}
var Xn = class extends ln {
    constructor(e) {
        ...
        this.isPseudoElement = !!i,
            ...
            e.type;
        let c = Yn(e);
        this.animation = qn(t, n, r, c, i),
            c.autoplay === !1 && this.animation.pause(),
            this.animation.onfinish = () => {
                if (this.finishedTime = this.time,
                    !i) {
                    let e = on(r, this.options, o, this.speed);
    ...
    attachTimeline({ timeline: e, rangeStart: t, rangeEnd: n, observe: r }) {
        return this.allowFlatten && this.animation.effect?.updateTiming({
            ...
            e && Vn() ? (this.animation.timeline = e,
...
function $n(e) {
    typeof e.ease == `string` && Qn(e.ease) && (e.ease = Zn[e.ease])
}
var er = 10
    , tr = class extends Xn {
        constructor(e) {
        ...
        updateMotionValue(e) {
            ...
            let o = new dn({
                ...
                , s = Math.max(er, M.now() - this.startTime)
                , c = m(0, er, s - er)
                , l = o.sample(s).value
                , { name: u } = this.options;
            i && u && Rn(i, u, l),
    ...
    , nr = (e, t) => t === `zIndex` ? !1 : !!(typeof e == `number` || Array.isArray(e) || typeof e == `string` && (R.test(e) || e === `0`) && !e.startsWith(`url(`));
function rr(e) {
    let t = e[0];
    if (e.length === 1)
        return !0;
...
function ir(e, t, n, r) {
    ...
    let a = e[e.length - 1]
        ...
        , s = nr(a, t);
    return `${t}${i}${a}${o ? a : i}`,
        !o || !s ? !1 : rr(e) || (n === `spring` || Jn(n)) && r
}
function ar(e) {
    e.duration = 0,
        e.type = `keyframes`
}
var or = new Set([`opacity`, `clipPath`, `filter`, `transform`])
    , sr = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function cr(e) {
    for (let t = 0; t < e.length; t++)
        if (typeof e[t] == `string` && sr.test(e[t]))
            return !0;
    return !1
}
var lr = new Set([`color`, `backgroundColor`, `outlineColor`, `fill`, `stroke`, `borderColor`, `borderTopColor`, `borderRightColor`, `borderBottomColor`, `borderLeftColor`])
    , ur = b(() => Object.hasOwnProperty.call(Element.prototype, `animate`));
function dr(e) {
    ...
    return ur() && n && (or.has(n) || lr.has(n) && cr(s)) && (n !== `transform` || !l) && !c && !r && i !== `mirror` && a !== 0 && o !== `inertia`
}
var fr = 40
    , pr = class extends ln {
        constructor({ autoplay: e = !0, delay: t = 0, type: n = `keyframes`, repeat: r = 0, repeatDelay: i = 0, repeatType: a = `loop`, keyframes: o, name: s, motionValue: c, element: l, ...u }) {
            ...
            this.keyframeResolver = new (l?.KeyframeResolver || In)(o, (e, t, n) => this.onKeyframesResolved(e, t, d, !n), s, c, l),
        ...
        onKeyframesResolved(e, t, n, r) {
            ...
            let u = !0;
            ir(e, i, a, o) || (u = !1,
                (g.instantAnimations || !s) && l?.(on(e, n, t)),
                e[0] = e[e.length - 1],
                ar(n),
                n.repeat = 0);
            let d = {
...
var vr = {
    ...
    , Sr = (e, { keyframes: t }) => t.length > 2 ? br : Tn.has(e) ? e.startsWith(`scale`) ? yr(t[1]) : vr : xr;
function Cr(e, t) {
    if (e?.inherit && t) {
        let { inherit: n, ...r } = e;
        return {
...
var Tr = new Set([`when`, `delay`, `delayChildren`, `staggerChildren`, `staggerDirection`, `repeat`, `repeatType`, `repeatDelay`, `from`, `elapsed`]);
function Er(e) {
    for (let t in e)
        if (!Tr.has(t))
            return !0;
...
var Dr = (e, t, n, r = {}, i, a) => o => {
    ...
    Er(s) || Object.assign(u, Sr(e, u)),
        u.duration &&= E(u.duration),
        u.repeatDelay &&= E(u.repeatDelay),
        u.from !== void 0 && (u.keyframes[0] = u.from);
    let d = !1;
    if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (ar(u),
        u.delay === 0 && (d = !0)),
        (g.instantAnimations || g.skipAnimations || i?.shouldSkipAnimations) && (d = !0,
            ar(u),
            u.delay = 0),
    ...
    return s.isSync ? new dn(u) : new pr(u)
}
    ;
function Or(e) {
    let t = [{}, {}];
...
var Ar = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...wn])
    , jr = 30
    , Mr = e => !isNaN(parseFloat(e))
    , Nr = {
        current: void 0
    }
    , Pr = class {
        ...
        setCurrent(e) {
            this.current = e,
                this.updatedAt = M.now(),
                this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Mr(this.current))
        }
        ...
        get() {
            return Nr.current && Nr.current.push(this),
                this.current
        }
        getPrevious() {
            return this.prev
        ...
        getVelocity() {
            let e = M.now();
            if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > jr)
                return 0;
...
var Fr = e => Array.isArray(e);
function Ir(e, t, n) {
    e.hasValue(t) ? e.getValue(t).set(n) : e.addValue(t, G(n))
}
function Lr(e) {
...
function Gr(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
...
function Kr(e, t, n = {}) {
    let r = W(e, t, n.type === `exit` ? e.presenceContext?.custom : void 0)
        , { transition: i = e.getDefaultTransition() || {} } = r || {};
    n.transitionOverride && (i = n.transitionOverride);
    let a = r ? () => Promise.all(Gr(e, r, n)) : () => Promise.resolve()
...
function qr(e, t, n = 0, r = 0, i = 0, a = 1, o) {
    ...
    for (let c of e.variantChildren)
        c.notify(`AnimationStart`, t),
            s.push(Kr(c, t, {
                ...o,
                delay: n + (typeof r == `function` ? 0 : r) + mr(e.variantChildren, c, r, i, a)
...
var Yr = {
    ...
    , Xr = e => t => t.test(e)
    , Zr = [Ie, I, F, P, Qe, Ze, Yr]
    , Qr = e => Zr.find(Xr(e));
function $r(e) {
    return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || y(e)
}
var ei = new Set([`brightness`, `contrast`, `saturate`, `opacity`]);
function ti(e) {
...
var di = new Set([`auto`, `none`, `0`]);
function fi(e, t, n) {
    let r = 0, i;
    for (; r < e.length && !i;) {
        let t = e[r];
        typeof t == `string` && !di.has(t) && lt(t).values.length && (i = e[r]),
            r++
    }
    if (i && n)
        for (let r of t)
...
var pi = class extends In {
    ...
    readKeyframes() {
        ...
        if (a !== o)
            if (En(a) && En(o))
                ...
                H[n] && (this.needsMeasurement = !0)
    }
    resolveNoneKeyframes() {
        let { unresolvedKeyframes: e, name: t } = this
            , n = [];
        for (let t = 0; t < e.length; t++)
            (e[t] === null || $r(e[t])) && n.push(t);
        n.length && fi(e, n, t)
    }
    measureInitialState() {
        ...
        n === `height` && (this.suspendedScrollY = window.pageYOffset),
            this.measuredOrigin = H[n](e.measureViewportBox(), window.getComputedStyle(e.current)),
    ...
    measureEndState() {
        ...
        let i = n.length - 1
            , a = n[i];
        n[i] = H[t](e.measureViewportBox(), window.getComputedStyle(e.current)),
...
function gi(e) {
    return v(e) && `offsetHeight` in e && !(`ownerSVGElement` in e)
}
var { schedule: _i, cancel: vi } = Ee(queueMicrotask, !1)
    , q = {
        x: !1,
        y: !1
    };
...
function Di(e) {
    return Ei.has(e.tagName) || e.isContentEditable === !0
}
var Oi = new Set([`INPUT`, `SELECT`, `TEXTAREA`]);
function ki(e) {
    return Oi.has(e.tagName) || e.isContentEditable === !0
}
var Ai = new WeakSet;
function ji(e) {
    return t => {
...
var Ni = (e, t) => {
    ...
    let r = ji(() => {
        ...
        n.addEventListener(`keyup`, e, t),
            n.addEventListener(`blur`, () => Mi(n, `cancel`), t)
    }
    );
...
function Ii(e, t, n = {}) {
    let [r, i, a] = xi(e, n)
        , o = e => {
            ...
            if (!Pi(e) || Fi.has(e))
                return;
            Ai.add(r),
                n.stopPropagation && Fi.add(e);
            let a = t(r, e)
                , o = (e, t) => {
                    window.removeEventListener(`pointerup`, s),
                        window.removeEventListener(`pointercancel`, c),
                        Ai.has(r) && Ai.delete(r),
                        Pi(e) && typeof a == `function` && a(e, {
                            success: t
                        })
                }
                , s = e => {
                    o(e, r === window || r === document || n.useGlobalTarget || wi(r, e.target))
                }
                , c = e => {
                    o(e, !1)
                }
    ...
    return r.forEach(e => {
        (n.useGlobalTarget ? window : e).addEventListener(`pointerdown`, o, i),
            gi(e) && (e.addEventListener(`focus`, e => Ni(e, i)),
                !Di(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0))
    }
    ),
        a
}
function Li(e) {
    return v(e) && `ownerSVGElement` in e
}
var Ri = new WeakMap, zi, Bi = (e, t, n) => (r, i) => i && i[0] ? i[0][e + `Size`] : Li(r) && `getBBox` in r ? r.getBBox()[t] : r[n], Vi = Bi(`inline`, `width`, `offsetWidth`), Hi = Bi(`block`, `height`, `offsetHeight`);
function Ui({ target: e, borderBoxSize: t }) {
    Ri.get(e)?.forEach(n => {
        n(e, {
            get width() {
                return Vi(e, t)
...
function Gi() {
    typeof ResizeObserver > `u` || (zi = new ResizeObserver(Wi))
}
function Ki(e, t) {
    zi || Gi();
    let n = mi(e);
...
function Xi(e) {
    return qi.add(e),
        ...
        () => {
            qi.delete(e),
                !qi.size && typeof Ji == `function` && (window.removeEventListener(`resize`, Ji),
                    Ji = void 0)
        }
}
function Zi(e, t) {
    return typeof e == `function` ? Xi(e) : Ki(e, t)
}
function Qi(e) {
...
var ba = class {
    ...
    mount(e) {
        ...
        this.current = e,
            ...
            this.reducedMotionConfig === `never` ? this.shouldReduceMotion = !1 : this.reducedMotionConfig === `always` ? this.shouldReduceMotion = !0 : (pa.current || ha(),
                this.shouldReduceMotion = fa.current),
    ...
    bindToMotionValue(e, t) {
        if (this.valueSubscriptions.has(e) && this.valueSubscriptions.get(e)(),
            t.accelerate && or.has(e) && this.current instanceof HTMLElement) {
    ...
    update(e, t) {
        ...
        this.prevMotionValues = da(this, this.scrapeMotionValuesFromProps(e, this.prevProps || {}, this), this.prevMotionValues),
    ...
    getValue(e, t) {
        ...
        let n = this.values.get(e);
        return n === void 0 && t !== void 0 && (n = G(t === null ? void 0 : t, {
            owner: this
        }),
            this.addValue(e, n)),
            n
    ...
    readValue(e, t) {
        ...
        return n != null && (typeof n == `string` && (_(n) || y(n)) ? n = parseFloat(n) : !ea(n) && R.test(t) && (n = ui(e, t)),
    ...
    on(e, t) {
        return this.events[e] || (this.events[e] = new T),
            this.events[e].add(t)
    }
    notify(e, ...t) {
...
function Ea({ scale: e, scaleX: t, scaleY: n }) {
    return !Ta(e) || !Ta(t) || !Ta(n)
}
function Da(e) {
    return Ea(e) || Oa(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY
}
function Oa(e) {
...
function ja(e, t, n, r, i) {
    return i !== void 0 && (e = Aa(e, i, r)),
        Aa(e, n, r) + t
}
function Ma(e, t = 0, n = 1, r, i) {
    e.min = ja(e.min, t, n, r, i),
        e.max = ja(e.max, t, n, r, i)
}
function Na(e, { x: t, y: n }) {
    Ma(e.x, t.translate, t.scale, t.originPoint),
        Ma(e.y, n.translate, n.scale, n.originPoint)
}
var Pa = .999999999999
    , Fa = 1.0000000000001;
function Ia(e, t, n, r = !1) {
    ...
    for (let s = 0; s < i; s++) {
        ...
        i && i.props.style && i.props.style.display === `contents` || (r && a.options.layoutScroll && a.scroll && a !== a.root && (X(e.x, -a.scroll.offset.x),
            X(e.y, -a.scroll.offset.y)),
            o && (t.x *= o.x.scale,
                t.y *= o.y.scale,
                Na(e, o)),
            r && Da(a.latestValues) && za(e, a.latestValues, a.layout?.layoutBox))
    }
    t.x < Fa && t.x > Pa && (t.x = 1),
        t.y < Fa && t.y > Pa && (t.y = 1)
}
...
function La(e, t, n, r, i = .5) {
    Ma(e, t, n, z(e.min, e.max, i), r)
}
function Ra(e, t) {
...
function za(e, t, n) {
    let r = n ?? e;
    La(e.x, Ra(t.x, r.x), t.scaleX, t.scale, t.originX),
        La(e.y, Ra(t.y, r.y), t.scaleY, t.scale, t.originY)
}
function Ba(e, t) {
    return Sa(wa(e.getBoundingClientRect(), t))
}
function Va(e, t, n) {
    let r = Ba(e, n)
        , { scroll: i } = t;
    return i && (X(r.x, i.offset.x),
        X(r.y, i.offset.y)),
        r
}
var Ha = {
...
function Ga(e, t, n) {
    ...
    if (t.transform || (o || n ? r.transform = Wa(t, e.transform, n) : r.transform &&= `none`),
        s) {
    ...
    correct: (e, t) => {
        ...
        if (typeof e == `string`)
            if (I.test(e))
                ...
                return e;
        return `${qa(e, t.target.x)}% ${qa(e, t.target.y)}%`
    }
}
    , Ya = {
...
function Za(e, { layout: t, layoutId: n }) {
    return Tn.has(e) || e.startsWith(`origin`) || (t || n !== void 0) && (!!Xa[e] || e === `opacity`)
}
function Qa(e, t, n) {
    let r = e.style
        , i = t?.style
    ...
    if (!r)
        return a;
    for (let t in r)
        (K(r[t]) || i && K(i[t]) || Za(t, e) || n?.getValue(t)?.liveStyle !== void 0) && (a[t] = r[t]);
    return a
}
function $a(e) {
    return window.getComputedStyle(e)
}
var eo = class extends xa {
    constructor() {
        super(...arguments),
            this.type = `html`,
            this.renderInstance = Ka
    }
    readValueFromInstance(e, t) {
        if (Tn.has(t))
            return this.projection?.isProjecting ? bn(t) : Sn(e, t);
        {
            let n = $a(e)
                , r = (je(t) ? n.getPropertyValue(t) : n[t]) || 0;
...
function ro(e, t, n = 1, r = 0, i = !0) {
    e.pathLength = 1;
    let a = i ? to : no;
    e[a.offset] = `${-r}`,
        e[a.array] = `${t} ${n}`
}
var io = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`];
function ao(e, { attrX: t, attrY: n, attrScale: r, pathLength: i, pathSpacing: a = 1, pathOffset: o = 0, ...s }, c, l, u) {
    ...
    t !== void 0 && (d.x = t),
        n !== void 0 && (d.y = n),
        r !== void 0 && (d.scale = r),
        i !== void 0 && ro(d, i, a, o, !1)
}
var oo = new Set([`baseFrequency`, `diffuseConstant`, `kernelMatrix`, `kernelUnitLength`, `keySplines`, `keyTimes`, `limitingConeAngle`, `markerHeight`, `markerWidth`, `numOctaves`, `targetX`, `targetY`, `surfaceScale`, `specularConstant`, `specularExponent`, `stdDeviation`, `tableValues`, `viewBox`, `gradientTransform`, `pathLength`, `startOffset`, `textLength`, `lengthAdjust`])
    , so = e => typeof e == `string` && e.toLowerCase() === `svg`;
function co(e, t, n, r) {
    Ka(e, t, void 0, r);
    for (let n in t.attrs)
        e.setAttribute(oo.has(n) ? n : Vr(n), t.attrs[n])
}
function lo(e, t, n) {
    let r = Qa(e, t, n);
    for (let n in e)
        if (K(e[n]) || K(t[n])) {
            let t = wn.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
            r[t] = e[n]
        }
    return r
}
var uo = class extends xa {
    constructor() {
        super(...arguments),
            this.type = `svg`,
            this.isSVGTag = !1,
        ...
        for (let t = 0; t < go; t++) {
            ...
            for (let e in T) {
                ...
                if (d.hasOwnProperty(e))
                    continue;
                let r = !1;
                r = Fr(t) && Fr(n) ? !mo(t, n) : t !== n,
                    r ? t == null ? u.add(e) : E(e) : t !== void 0 && u.has(e) ? E(e) : m.protectedKeys[e] = !0
            }
            m.prevProp = h,
...
function jo(e, t, n, r = .5) {
    e.origin = r,
        e.originPoint = z(t.min, t.max, e.origin),
        e.scale = Q(n) / Q(t),
        e.translate = z(n.min, n.max, e.origin) - e.originPoint,
        (e.scale >= To && e.scale <= Eo || isNaN(e.scale)) && (e.scale = 1),
        (e.translate >= Oo && e.translate <= ko || isNaN(e.translate)) && (e.translate = 0)
}
function Mo(e, t, n, r) {
    jo(e.x, t.x, n.x, r ? r.originX : void 0),
        jo(e.y, t.y, n.y, r ? r.originY : void 0)
}
function No(e, t, n, r = 0) {
    e.min = (r ? z(n.min, n.max, r) : n.min) + t.min,
        e.max = e.min + Q(t)
}
function Po(e, t, n, r) {
    No(e.x, t.x, n.x, r?.x),
...
function Lo(e, t, n, r, i) {
    return e -= t,
        e = Aa(e, 1 / n, r),
        i !== void 0 && (e = Aa(e, 1 / i, r)),
        e
}
function Ro(e, t = 0, n = 1, r = .5, i, a = e, o = e) {
    if (F.test(t) && (t = parseFloat(t),
        t = z(o.min, o.max, t / 100) - o.min),
        typeof t != `number`)
        return;
    let s = z(a.min, a.max, r);
    e === a && (s -= t),
        e.min = Lo(e.min, t, n, s, i),
        e.max = Lo(e.max, t, n, s, i)
}
function zo(e, t, [n, r, i], a, o) {
    Ro(e, t[n], t[r], t[i], t.scale, a, o)
}
var Bo = [`x`, `scaleX`, `originX`]
    , Vo = [`y`, `scaleY`, `originY`];
function Ho(e, t, n, r) {
    zo(e.x, t, Bo, n ? n.x : void 0, r ? r.x : void 0),
        zo(e.y, t, Vo, n ? n.y : void 0, r ? r.y : void 0)
}
function Uo(e) {
...
var Qo = [`borderTopLeftRadius`, `borderTopRightRadius`, `borderBottomLeftRadius`, `borderBottomRightRadius`]
    , $o = Qo.length
    , es = e => typeof e == `string` ? parseFloat(e) : e
    , ts = e => typeof e == `number` || I.test(e);
function ns(e, t, n, r, i, a) {
    i ? (e.opacity = z(0, n.opacity ?? 1, is(r)),
        e.opacityExit = z(t.opacity ?? 1, 0, as(r))) : a && (e.opacity = z(t.opacity ?? 1, n.opacity ?? 1, r));
    for (let i = 0; i < $o; i++) {
        let a = Qo[i]
            , o = rs(t, a)
            , s = rs(n, a);
        o === void 0 && s === void 0 || (o ||= 0,
            s ||= 0,
            o === 0 || s === 0 || ts(o) === ts(s) ? (e[a] = Math.max(z(es(o), es(s), r), 0),
                (F.test(s) || F.test(o)) && (e[a] += `%`)) : e[a] = s)
    }
    ...
    add(e) {
        ...
        for (let t = this.members.length - 1; t >= 0; t--) {
            ...
            if (n === e || n === this.lead || n === this.prevLead)
                continue;
            let r = n.instance;
            (!r || r.isConnected === !1) && !n.snapshot && (p(this.members, n),
                n.unmount())
        }
        e.scheduleRender()
    }
...
function xs({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: i }) {
    return class {
        constructor(e = {}, n = t?.()) {
            this.id = vs++,
                ...
                this.updateProjection = () => {
                    this.projectionUpdateScheduled = !1,
                        O.value && (hs.nodes = hs.calculatedTargetDeltas = hs.calculatedProjections = 0),
                        this.nodes.forEach(ws),
                        this.nodes.forEach(Ns),
                        this.nodes.forEach(Ps),
                        this.nodes.forEach(Ts),
                        O.addProjectionMetrics && O.addProjectionMetrics(hs)
                }
                ,
        ...
        addEventListener(e, t) {
            return this.eventHandlers.has(e) || this.eventHandlers.set(e, new T),
        ...
        mount(t) {
            ...
            n && this.root.registerSharedNode(n, this),
                this.options.animate !== !1 && i && (n || r) && this.addEventListener(`didUpdate`, ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
                    ...
                    let a = this.options.transition || i.getDefaultTransition() || Vs
                        , { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } = i.getProps()
                        , c = !this.targetLayout || !Jo(this.targetLayout, r)
                        , l = !t && n;
        ...
        startUpdate() {
            this.isUpdateBlocked() || (this.isUpdating = !0,
                this.nodes && this.nodes.forEach(Fs),
                this.animationId++)
        }
        ...
        willUpdate(e = !0) {
            ...
            if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bs(this),
        ...
        update() {
            ...
            this.animationCommitId = this.animationId,
                this.isUpdating ? (this.isUpdating = !1,
                    ...
                    this.nodes.forEach(Cs)) : this.nodes.forEach(ks),
                this.clearAllSnapshots();
            let e = M.now();
            j.delta = m(0, 1e3 / 60, e - j.timestamp),
                j.timestamp = e,
                j.isProcessing = !0,
                De.update.process(j),
        ...
        didUpdate() {
            this.updateScheduled || (this.updateScheduled = !0,
                _i.read(this.scheduleUpdate))
        }
        clearAllSnapshots() {
            this.nodes.forEach(Es),
                this.sharedNodes.forEach(Is)
        }
        ...
        updateSnapshot() {
            this.snapshot || !this.instance || (this.snapshot = this.measure(),
                this.snapshot && !Q(this.snapshot.measuredBox.x) && !Q(this.snapshot.measuredBox.y) && (this.snapshot = void 0))
        }
        updateLayout() {
        ...
        resetTransform() {
            ...
            e && this.instance && (t || Da(this.latestValues) || a) && (i(this.instance, r),
                this.shouldResetTransform = !1,
                this.scheduleRender())
        }
        measure(e = !0) {
        ...
        measurePageBox() {
            ...
            if (!(this.scroll?.wasRoot || this.path.some(qs))) {
        ...
        removeElementScroll(e) {
            ...
            for (let n = 0; n < this.path.length; n++) {
                ...
                r !== this.root && i && a.layoutScroll && (i.wasRoot && Z(t, e),
                    X(t.x, i.offset.x),
                    X(t.y, i.offset.y))
            }
            return t
        ...
        applyTransform(e, t = !1, n) {
            ...
            for (let e = 0; e < this.path.length; e++) {
                let n = this.path[e];
                !t && n.options.layoutScroll && n.scroll && n !== n.root && (X(r.x, -n.scroll.offset.x),
                    X(r.y, -n.scroll.offset.y)),
                    Da(n.latestValues) && za(r, n.latestValues, n.layout?.layoutBox)
            }
            return Da(this.latestValues) && za(r, this.latestValues, this.layout?.layoutBox),
                r
        }
        removeTransform(e) {
            let t = J();
            ...
            for (let e = 0; e < this.path.length; e++) {
                let n = this.path[e];
                if (!Da(n.latestValues))
                    continue;
                let r;
                n.instance && (Ea(n.latestValues) && n.updateSnapshot(),
                    r = J(),
                    Z(r, n.measurePageBox())),
                    Ho(t, n.latestValues, n.snapshot?.layoutBox, r)
            }
            return Da(this.latestValues) && Ho(t, this.latestValues),
                t
        }
        setTargetDelta(e) {
            this.targetDelta = e,
        ...
        resolveTargetDelta(e = !1) {
            ...
            a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(),
                ...
                !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = J(),
                    this.targetWithTransforms = J()),
                    this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(),
                        Po(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Z(this.target, this.layout.layoutBox),
                            Na(this.target, this.targetDelta)) : Z(this.target, this.layout.layoutBox),
                    ...
                    O.value && hs.calculatedTargetDeltas++)
        }
        getClosestProjectingParent() {
            if (!(!this.parent || Ea(this.parent.latestValues) || Oa(this.parent.latestValues)))
        ...
        createRelativeTarget(e, t, n) {
            this.relativeParent = e,
                ...
                Io(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0),
        ...
        calcProjection() {
            ...
            !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (Co(this.prevProjectionDelta.x, this.projectionDelta.x),
                Co(this.prevProjectionDelta.y, this.projectionDelta.y)),
                Mo(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
                (this.treeScale.x !== a || this.treeScale.y !== o || !Xo(this.projectionDelta.x, this.prevProjectionDelta.x) || !Xo(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0,
                    this.scheduleRender(),
                    this.notifyListeners(`projectionUpdate`, s)),
                O.value && hs.calculatedProjections++
        }
        hide() {
            this.isVisible = !1
        }
        ...
        setAnimationOrigin(e, t = !1) {
            ...
            let o = J()
                ...
                , u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(Bs));
            this.animationProgress = 0;
            let d;
            this.mixTargetDelta = t => {
                ...
                Ls(a.x, e.x, n),
                    ...
                    this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Io(o, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0),
                        zs(this.relativeTarget, this.relativeTargetOrigin, o, n),
                        d && Ko(this.relativeTarget, d) && (this.isProjectionDirty = !1),
                        d ||= J(),
                        Z(d, this.relativeTarget)),
                    s && (this.animationValues = i,
                        ns(i, r, this.latestValues, n, u, l)),
                    this.root.scheduleUpdateProjection(),
                    this.scheduleRender(),
        ...
        startAnimation(e) {
            this.notifyListeners(`animationStart`),
                ...
                this.pendingAnimation &&= (A(this.pendingAnimation),
                    void 0),
                this.pendingAnimation = k.update(() => {
                    ms.hasAnimatedSinceResize = !0,
                        N.layout++,
                        this.motionValue ||= G(0),
                        this.motionValue.jump(0, !1),
                        this.currentAnimation = ss(this.motionValue, [0, 1e3], {
                            ...e,
                            velocity: 0,
                            isSync: !0,
                            onUpdate: t => {
        ...
        finishAnimation() {
            this.currentAnimation && (this.mixTargetDelta && this.mixTargetDelta(_s),
                this.currentAnimation.stop()),
                this.completeAnimation()
        }
        applyTransformsToTarget() {
            ...
            if (!(!t || !n || !r)) {
                ...
                Z(t, n),
                    za(t, i),
                    Mo(this.projectionDeltaWithTransform, this.layoutCorrected, t, i)
            }
        }
        registerSharedNode(e, t) {
            this.sharedNodes.has(e) || this.sharedNodes.set(e, new ps),
        ...
        resetSkewAndRotation() {
            ...
            if ((n.z || n.rotate || n.rotateX || n.rotateY || n.rotateZ || n.skewX || n.skewY) && (t = !0),
                ...
                return;
            let r = {};
            n.z && ys(`z`, e, r, this.animationValues);
            for (let t = 0; t < gs.length; t++)
                ys(`rotate${gs[t]}`, e, r, this.animationValues),
                    ys(`skew${gs[t]}`, e, r, this.animationValues);
            e.render();
            for (let t in r)
        ...
        applyProjectionStyles(e, t) {
            ...
            if (this.needsReset) {
                this.needsReset = !1,
                    e.visibility = ``,
                    e.opacity = ``,
                    e.pointerEvents = fs(t?.pointerEvents) || ``,
            ...
            if (!this.projectionDelta || !this.layout || !r.target) {
                this.options.layoutId && (e.opacity = this.latestValues.opacity === void 0 ? 1 : this.latestValues.opacity,
                    e.pointerEvents = fs(t?.pointerEvents) || ``),
                    this.hasProjected && !Da(this.latestValues) && (e.transform = n ? n({}, ``) : `none`,
                        this.hasProjected = !1);
                return
            }
            e.visibility = ``;
            ...
            let a = Zo(this.projectionDeltaWithTransform, this.treeScale, i);
            n && (a = n(i, a)),
                e.transform = a;
            ...
            for (let t in Xa) {
                if (i[t] === void 0)
                    continue;
                let { correct: n, applyTo: o, isCSSVariable: s } = Xa[t]
...
function Cs(e) {
    ...
    if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
        ...
        if (i === `size`)
            ...
            let e = i === `x` ? `y` : `x`;
            So(a ? t.measuredBox[e] : t.layoutBox[e], n[e])
        } else
            Ks(i, t.layoutBox, n) && $(r => {
        ...
        Mo(o, n, t.layoutBox);
        let s = na();
        a ? Mo(s, e.applyTransform(r, !0), t.measuredBox) : Mo(s, n, t.layoutBox);
        let c = !Wo(o)
            , l = !1;
        if (!e.resumeFrom) {
            ...
            if (r && !r.resumeFrom) {
                ...
                if (i && a) {
                    let o = e.options.layoutAnchor || void 0
                        , s = J();
                    Io(s, t.layoutBox, i.layoutBox, o);
                    let c = J();
                    Io(c, n, a.layoutBox, o),
                        Jo(s, c) || (l = !0),
...
var Vs = {
    ...
    , Hs = e => typeof navigator < `u` && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e)
    , Us = Hs(`applewebkit/`) && !Hs(`chrome/`) ? Math.round : x;
function Ws(e) {
    e.min = Us(e.min),
        e.max = Us(e.max)
}
...
function Ks(e, t, n) {
    return e === `position` || e === `preserve-aspect` && !Ao(Yo(t), Yo(n), .2)
}
function qs(e) {
...
function dc(e) {
    typeof e == `function` && (uc = t => t.startsWith(`on`) ? !oc(t) : e(t))
}
try {
    dc((lc(),
        e(sc)).default)
...
function fc(e, t, n) {
    let r = {};
    for (let i in e)
        i === `values` && typeof e.values == `object` || K(e[i]) || (uc(i) || n === !0 && oc(i) || !t && !oc(i) || e.draggable && i.startsWith(`onDrag`)) && (r[i] = e[i]);
    return r
}
var pc = (0,
    s.createContext)({});
...
function hc(e) {
    let { initial: t, animate: n } = mc(e, (0,
        s.useContext)(pc));
    return (0,
        s.useMemo)(() => ({
            initial: t,
...
function Cc(e, t, n, r) {
    let i = (0,
        s.useMemo)(() => {
            let n = Sc();
            return ao(n, t, so(r), e.transformTemplate, e.style),
            {
                ...n.attrs,
                style: {
                    ...n.style
...
var wc = [`animate`, `circle`, `defs`, `desc`, `ellipse`, `g`, `image`, `line`, `filter`, `marker`, `mask`, `metadata`, `path`, `pattern`, `polygon`, `polyline`, `rect`, `stop`, `switch`, `symbol`, `svg`, `text`, `tspan`, `use`, `view`];
function Tc(e) {
    return typeof e != `string` || e.includes(`-`) ? !1 : !!(wc.indexOf(e) > -1 || /[A-Z]/u.test(e))
}
function Ec(e, t, n, { latestValues: r }, i, a = !1, o) {
    let c = (o ?? Tc(e) ? Cc : xc)(t, r, i, e)
        , l = fc(t, typeof e == `string`, a)
        , u = e === s.Fragment ? {} : {
            ...l,
            ...c,
            ref: n
...
function Dc({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
    return {
        latestValues: Oc(n, r, i, e),
        renderState: t()
    }
}
function Oc(e, t, n, r) {
...
function Ic(e, t, n, r, i, a) {
    ...
    let _ = h.current
        , v = (0,
            s.useContext)(Pc);
    _ && !_.projection && i && (_.type === `html` || _.type === `svg`) && Lc(h.current, n, i, v);
    let y = (0,
        s.useRef)(!1);
    (0,
        s.useInsertionEffect)(() => {
    ...
    let b = n[Hr]
        , x = (0,
            s.useRef)(!!b && typeof window < `u` && !window.MotionHandoffIsComplete?.(b) && window.MotionHasOptimisedAnimation?.(b));
    return u(() => {
        g.current = !0,
            _ && (y.current = !0,
        ...
        (0,
            s.useEffect)(() => {
                _ && (!x.current && _.animationState && _.animationState.animateChanges(),
...
function Lc(e, t, n, r) {
    ...
    e.projection = new n(e.latestValues, t[`data-framer-portal-id`] ? void 0 : Rc(e.parent)),
        e.projection.setOptions({
            layoutId: i,
            layout: a,
            alwaysMeasureLayout: !!o || s && Fc(s),
            visualElement: e,
...
function Rc(e) {
    if (e)
        return e.options.allowProjection === !1 ? Rc(e.parent) : e.projection
}
function zc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
    r && ic(r);
    let a = n ? n === `svg` : Tc(e)
        , c = a ? jc : Ac;
    function l(n, l) {
        let u, d = {
            ...
            ...n,
            layoutId: Bc(n)
        }, { isStatic: f } = d, p = hc(n), m = c(n, f);
        if (!f && typeof window < `u`) {
            Vc(d, r);
            let t = Hc(d);
            u = t.MeasureLayout,
                p.visualElement = Ic(e, m, d, i, t.ProjectionNode, a)
        }
        return (0,
            o.jsxs)(pc.Provider, {
                value: p,
                children: [u && p.visualElement ? (0,
                    o.jsx)(u, {
                        visualElement: p.visualElement,
                        ...d
                    }) : null, Ec(e, n, Nc(m, p.visualElement, l), m, f, t, a)]
            })
    }
...
function Vc(e, t) {
    (0,
        s.useContext)($s).strict
}
function Hc(e) {
    let { drag: t, layout: n } = rc();
    if (!t && !n)
        return {};
    let r = {
        ...t,
...
function Uc(e, t) {
    ...
    return new Proxy((e, t) => r(e, t), {
        get: (i, a) => a === `create` ? r : (n.has(a) || n.set(a, zc(a, void 0, e, t)),
            n.get(a))
    })
}
var Wc = (e, t) => t.isSVG ?? Tc(e) ? new uo(t) : new eo(t, {
    allowProjection: e !== s.Fragment
})
    , Gc = class extends Y {
        constructor(e) {
            super(e),
                e.animationState ||= vo(e)
        }
...
var Yc = e => t => Ti(t) && e(t, Jc(t));
function Xc(e, t, n, r) {
    return cs(e, t, Yc(n), r)
}
var Zc = ({ current: e }) => e ? e.ownerDocument.defaultView : null
    , Qc = (e, t) => Math.abs(e - t);
function $c(e, t) {
    let n = Qc(e.x, t.x)
        , r = Qc(e.y, t.y);
...
var el = new Set([`auto`, `scroll`])
    , tl = class {
        constructor(e, t, { transformPagePoint: n, contextWindow: r = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3, element: o } = {}) {
            if (this.startEvent = null,
                ...
                this.updatePoint = () => {
                    if (!(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    this.lastRawMoveEventInfo && (this.lastMoveEventInfo = nl(this.lastRawMoveEventInfo, this.transformPagePoint));
                    let e = il(this.lastMoveEventInfo, this.history)
                ...
                this.handlePointerUp = (e, t) => {
                    ...
                    if ((this.dragSnapToOrigin || !this.startEvent) && i && i(),
                        ...
                        return;
                    let a = il(e.type === `pointercancel` ? this.lastMoveEventInfo : nl(t, this.transformPagePoint), this.history);
            ...
            let s = nl(Jc(e), this.transformPagePoint)
                , { point: c } = s
                , { timestamp: l } = j;
            this.history = [{
                ...c,
            ...
            u && u(e, il(s, this.history)),
                this.removeListeners = C(Xc(this.contextWindow, `pointermove`, this.handlePointerMove), Xc(this.contextWindow, `pointerup`, this.handlePointerUp), Xc(this.contextWindow, `pointercancel`, this.handlePointerUp)),
        ...
        startScrollTracking(e) {
            ...
            for (; t;) {
                ...
                (el.has(e.overflowX) || el.has(e.overflowY)) && this.scrollPositions.set(t, {
                    x: t.scrollLeft,
                    y: t.scrollTop
                }),
                    t = t.parentElement
...
function sl(e, t) {
    ...
    r === e[0] && e.length > 2 && i.timestamp - r.timestamp > E(t) * 2 && (r = e[1]);
    let a = D(i.timestamp - r.timestamp);
    if (a === 0)
        return {
            x: 0,
            y: 0
...
function ul(e, { top: t, left: n, bottom: r, right: i }) {
    return {
        x: ll(e.x, n, i),
        y: ll(e.y, t, r)
    }
...
function pl(e, t) {
    let n = .5
        , r = Q(e)
        , i = Q(t);
    return i > r ? n = w(t.min, t.max - r, e.min) : r > i && (n = w(e.min, e.max - i, t.min)),
        m(0, 1, n)
}
function ml(e, t) {
    let n = {};
    ...
    , bl = class {
        ...
        start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
            ...
            if (r && r.isPresent === !1)
                return;
            let i = e => {
                t && this.snapToCursor(Jc(e).point),
                    this.stopAnimation()
            }
                , a = (e, t) => {
                    ...
                    this.latestPointerEvent = e,
                        ...
                        Br(this.visualElement, `transform`);
        ...
        updateAxis(e, t, n) {
            ...
            this.constraints && this.constraints[e] && (a = cl(a, this.constraints[e], this.elastic[e])),
                i.set(a)
        }
        resolveConstraints() {
            let { dragConstraints: e, dragElastic: t } = this.getProps()
                ...
                , r = this.constraints;
            e && Fc(e) ? this.constraints ||= this.resolveRefConstraints() : e && n ? this.constraints = ul(n.layoutBox, e) : this.constraints = !1,
                this.elastic = gl(t),
                r !== this.constraints && !Fc(e) && n && this.constraints && !this.hasMutatedConstraints && $(e => {
                    this.constraints !== !1 && this.getAxisMotionValue(e) && (this.constraints[e] = ml(n.layoutBox[e], this.constraints[e]))
                }
                )
        }
        resolveRefConstraints() {
            ...
            if (!r || !r.layout)
                return !1;
            let i = Va(n, r.root, this.visualElement.getTransformPagePoint())
                , a = fl(r.layout.layoutBox, i);
            if (t) {
                let e = t(Ca(a));
        ...
        startAnimation(e) {
            let { drag: t, dragMomentum: n, dragElastic: r, dragTransition: i, dragSnapToOrigin: a, onDragTransitionEnd: o } = this.getProps()
                , s = this.constraints || {}
                , c = $(o => {
                    if (!Cl(o, t, this.currentDirection))
                        return;
                    let c = s && s[o] || {};
                    (a === !0 || a === o) && (c = {
                        min: 0,
        ...
        startAxisValueAnimation(e, t) {
            ...
            return Br(this.visualElement, e),
                n.start(Dr(e, n, 0, t, this.visualElement, !1))
        }
        stopAnimation() {
        ...
        snapToCursor(e) {
            $(t => {
                ...
                if (!Cl(t, n, this.currentDirection))
                    return;
        ...
        addListeners() {
            ...
            let e = this.visualElement.current, t = Xc(e, `pointerdown`, t => {
                ...
                Fc(t) && t.current && (this.constraints = this.resolveRefConstraints(),
                    n ||= Sl(e, t.current, () => this.scalePositionWithinConstraints()))
            }
                , { projection: i } = this.visualElement, a = i.addEventListener(`measure`, r);
            i && !i.layout && (i.root && i.root.updateScroll(),
                i.updateLayout()),
                k.read(r);
            let o = cs(window, `resize`, () => this.scalePositionWithinConstraints())
        ...
        getProps() {
            let e = this.visualElement.getProps()
                , { drag: t = !1, dragDirectionLock: n = !1, dragPropagation: r = !1, dragConstraints: i = !1, dragElastic: a = hl, dragMomentum: o = !0 } = e;
            return {
                ...e,
                drag: t,
                dragDirectionLock: n,
...
var Tl = class extends Y {
    ...
    , Dl = class extends Y {
        ...
        mount() {
            this.removePointerDownListener = Xc(this.node.current, `pointerdown`, e => this.onPointerDown(e))
        }
        update() {
    ...
    , kl = class extends s.Component {
        ...
        getSnapshotBeforeUpdate(e) {
            ...
            return a ? (a.isPresent = i,
                ...
                e.isPresent !== i && (i ? a.promote() : a.relegate() || k.postRender(() => {
                    let e = a.getStack();
...
function Ml(e, t, n) {
    ...
    let i = r[`onHover` + n];
    i && k.postRender(() => i(t, Jc(t)))
}
var Nl = class extends Y {
    mount() {
        let { current: e } = this.node;
        e && (this.unmount = Ci(e, (e, t) => (Ml(this.node, t, `Start`),
            e => Ml(this.node, e, `End`))))
    }
    unmount() { }
}
    , Pl = class extends Y {
        ...
        mount() {
            this.unmount = C(cs(this.node.current, `focus`, () => this.onFocus()), cs(this.node.current, `blur`, () => this.onBlur()))
        }
        unmount() { }
    }
    ;
...
var Il = class extends Y {
    mount() {
        ...
        this.unmount = Ii(e, (e, t) => (Fl(this.node, t, `Start`),
            (e, { success: t }) => Fl(this.node, e, t ? `End` : `Cancel`)), {
            useGlobalTarget: t,
...
function Vl({ root: e, ...t }) {
    ...
    let r = Rl.get(n)
        , i = JSON.stringify(t);
    return r[i] || (r[i] = new IntersectionObserver(Bl, {
        root: e,
        ...t
    })),
        r[i]
...
var Ul = {
    ...
    , Wl = class extends Y {
        ...
        startObserver() {
            ...
            let { viewport: e = {} } = this.node.getProps()
                ...
                , a = {
                    ...
                    rootMargin: n,
                    threshold: typeof r == `number` ? r : Ul[r]
                };
            this.stopObserver = Hl(this.node.current, a, e => {
        ...
        update() {
            ...
            [`amount`, `margin`, `root`].some(Gl(e, t)) && this.startObserver()
        }
        unmount() {
            this.stopObserver?.(),
                this.hasEnteredView = !1,
...
export { k as A, d as B, en as C, Lt as D, qt as E, w as F, l as H, x as I, h as L, ve as M, ee as N, z as O, E as P, m as R, dn as S, Qt as T, c as U, u as V, Nr as _, uo as a, Vn as b, ia as c, Zi as d, Li as f, K as g, Gr as h, ss as i, j, A as k, J as l, mi as m, Qs as n, eo as o, gi as p, Zs as r, ba as s, Jl as t, Qi as u, G as v, $t as w, Hn as x, Jn as y, p as z };
