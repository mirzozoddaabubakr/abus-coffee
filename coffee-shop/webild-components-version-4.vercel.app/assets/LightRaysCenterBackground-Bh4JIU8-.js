...
var n = e()
    , r = ({ position: e }) => (0,
        n.jsxs)(`div`, {
            className: t(e, `inset-0 -z-10 overflow-hidden pointer-events-none select-none`),
            "aria-hidden": `true`,
            children: [(0,
                n.jsx)(`div`, {
                    ...
                    n.jsxs)(`div`, {
                        className: `absolute -top-[400px] left-1/2 -translate-x-1/2 w-[1142px] h-[129vh] overflow-hidden blur-lg mask-[radial-gradient(50%_109%,#000_0%,#000000f6_0%,transparent_96%)]`,
                        children: [(0,
                            n.jsx)(`div`, {
                                ...
                                style: {
                                    ...
                                    animation: `ray-pulse 4s ease-in-out 0s infinite both`
                                }
                            }), (0,
                                n.jsx)(`div`, {
                                    className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                    style: {
                                        ...
                                        animation: `ray-pulse 3.5s ease-in-out 0.5s infinite both`
                                    }
                                }), (0,
                                    n.jsx)(`div`, {
                                        ...
                                        style: {
                                            ...
                                            animation: `ray-pulse 5s ease-in-out 1.2s infinite both`
                                        }
                                    }), (0,
                                        n.jsx)(`div`, {
                                            ...
                                            style: {
                                                ...
                                                animation: `ray-pulse 3s ease-in-out 0.3s infinite both`
                                            }
                                        }), (0,
                                            n.jsx)(`div`, {
                                                ...
                                                style: {
                                                    ...
                                                    animation: `ray-pulse 4.5s ease-in-out 0.8s infinite both`
                                                }
                                            }), (0,
                                                n.jsx)(`div`, {
                                                    className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-10px)] w-[20px] origin-top overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                    style: {
                                                        "--ray-opacity": .525,
                                                        transform: `rotate(3deg)`,
                                                        animation: `ray-pulse 3.2s ease-in-out 1.5s infinite both`
                                                    }
                                                }), (0,
                                                    n.jsx)(`div`, {
                                                        className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-7.5px)] w-[15px] origin-top overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                        style: {
                                                            "--ray-opacity": .725,
                                                            transform: `scale(0.9) rotate(5deg)`,
                                                            animation: `ray-pulse 4.2s ease-in-out 0.2s infinite both`
                                                        }
                                                    }), (0,
                                                        n.jsx)(`div`, {
                                                            className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                            style: {
                                                                "--ray-opacity": .6,
                                                                transform: `rotate(12deg)`,
                                                                animation: `ray-pulse 3.8s ease-in-out 1s infinite both`
                                                            }
                                                        }), (0,
                                                            n.jsx)(`div`, {
                                                                className: `absolute -top-[352px] -bottom-[920px] left-[calc(50%-17.5px)] w-[35px] origin-top overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`,
                                                                style: {
                                                                    "--ray-opacity": 1,
                                                                    transform: `rotate(20deg)`,
                                                                    animation: `ray-pulse 4s ease-in-out 0.7s infinite both`
                                                                }
                                                            }), (0,
                                                                n.jsx)(`div`, {
                                                                    className: `absolute left-[calc(50%-599px)] -top-[352px] -bottom-[46px] w-[1198px] opacity-[0.025] overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`
                                                                }), (0,
                                                                    n.jsx)(`div`, {
                                                                        className: `absolute left-[calc(50%-432.5px)] -top-[252px] w-[865px] h-[929px] opacity-10 overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`
                                                                    }), (0,
                                                                        n.jsx)(`div`, {
                                                                            className: `absolute left-[calc(50%-432.5px)] -top-[252px] w-[865px] h-[929px] opacity-10 overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,var(--color-background-accent)_0%,transparent_100%)]`
                                                                        })]
